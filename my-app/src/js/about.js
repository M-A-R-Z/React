...
function Section({ children, className }) {
  ...
  return (
    <div
      ref={ref}
      className={`${className} ${inView ? 'fade-in-section' : 'hidden-section'}`}
    >
      {children}
    </div>
  );
...
function About() {
  ...
  return (
    <>
      <Header />
      <div className="aboutintro-container animated-section"></div>

      <div className="about-container">
        <div className="about-content animated-section" style={{ animationDelay: '0.3s' }}>
        ...
        <p className="second-paragraph animated-section" style={{ animationDelay: '0.5s' }}>
        ...
        <div className="strand-box animated-section" style={{ animationDelay: '0.7s' }}>
          <img src={strandlogo} alt="strand" className="strandlogo1" />
        </div>

        <div className="mission-vision">
          <div className="overlay-mission about-mission animated-section" style={{ animationDelay: '0.9s' }}>
            <h1 className='mission-title'>🔍︎ Mission</h1>
            <p className='mission-p'>
              To empower incoming senior high school students by providing a personalized, data-driven guidance system that
              helps them discover college courses and career paths aligned with their passions, strengths, and real-world 
              opportunities—turning uncertainty into clarity and potential into purpose.
            </p>
          </div>

          <div className='about-vision animated-section' style={{ animationDelay: '1.1s' }}>
            <h1 className='vision-title'>👁 Vision</h1>
            <p className='vision-p'>
              To become the leading digital companion for Filipino youth in their academic and career journey—bridging the 
        ...
        <div className="dropdown-section animated-section" style={{ animationDelay: '1.3s' }}>
          {options.map((item, index) => (
            <div key={index} className="dropdown-item">
              <div onClick={() => toggleIndex(index)} className="dropdown-header">
