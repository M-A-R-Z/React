...
function AnimatedSection({ children, delay = '0s' }) {
  const { ref, inView } = useInView({ triggerOnce: true, threshold: 0.2 });

  return (
    <div
      ref={ref}
      className={`animated-section ${inView ? 'fade-in-section' : 'hidden-section'}`}
    ...
    <>
      ...
      <div className="career-container">
        ...
        <AnimatedSection delay="0.8s">
          <img src={HUMSS} alt="HUMSS" className="strand-image" />
