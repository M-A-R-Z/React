...
import '../css/Userdashboard-home.css';
        ...
        <div className="graphS">
            ...
            {tie && (
                <div className="tie-container">
                    ...
                    <p>
                        The final recommendation was determined based on the strand with the highest overall weight, which resulted as ABM being the most prominent out of the other strands.
                    </p>
                </div>
            )}
        </div>
